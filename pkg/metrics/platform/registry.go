...
const SlowQueryPromNamespace = "slow_query_platform"
...
var (
	...
	ExplainProcessSummary = promauto.NewSummaryVec(
		prometheus.SummaryOpts{
			Namespace:  SlowQueryPromNamespace,
			Name:       "slow_query_explain_duration_ms",
			Help:       "This metric will provide the statistics about the slow query explain duration_ms",
			Objectives: map[float64]float64{0.5: 0.05, 0.75: 0.05, 0.90: 0.01, 0.95: 0.01, 0.99: 0.001}, //nolint:gomnd
		},
		[]string{"name", "status"},
	)
