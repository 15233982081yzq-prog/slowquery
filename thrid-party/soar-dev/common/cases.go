...
func init() {
	...
	TestSQLs = []string{
		...
		// https://smart-slowquery/thrid-party/soar-dev/issues/47
		...
		// https://smart-slowquery/thrid-party/soar-dev/issues/17
		"create table hello.t (id int unsigned);",

		// https://smart-slowquery/thrid-party/soar-dev/issues/146
		"select * from tb where data >= '';",

		// https://smart-slowquery/thrid-party/soar-dev/issues/163
