...
import (
	...
	"smart-slowquery/thrid-party/soar-dev/env"
...
func TestRuleImplicitConversion(t *testing.T) {
	...
	sqls := [][]string{
		...
		// OK
		{
			...
			"SELECT * FROM t4 WHERE col = 1", // https://smart-slowquery/thrid-party/soar-dev/issues/151
	...
	for _, sql := range sqls[0] {
		...
		idxAdvisor, err := NewAdvisor("", nil, *q, "")
		if err != nil {
